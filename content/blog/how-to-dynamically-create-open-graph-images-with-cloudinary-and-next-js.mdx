...
Read on to learn how to do this, or check out my [open source blogfolio on GitHub](https://github.com/Arva-Kachwala/braydoncoyer.dev) and see how I accomplished this.
...
export function Container(props) {
  const { children, ...customMeta } = props;
    ...
    type: 'article'
    twitterHandle: "https://www.linkedin.com/in/arva-kachwala/",
...
If you've made it this far and completed this article, I'd love for you to reach out to me on [LinkedIn](https://www.linkedin.com/in/arva-kachwala/) and send me a link to your blog or website so I can see the Open Graph images at work!
