  ...
  return (
    <div className="relative">
      ...
      <div className="space-y-12">
        ...
        <GridWrapper>
          <div className="relative mx-auto grid max-w-2xl grid-cols-2 place-items-center justify-items-center gap-y-6 sm:grid-cols-3">
            {socials.map((social) => (
              <a
                key={social.name}
                href={social.href}
              ...
              >
                <div className="group inline-block text-center">
                  <div className="h-28 w-28 rounded-[20px] border border-border-primary bg-bg-primary p-2 transition-all duration-300 group-hover:-translate-y-3 group-hover:border-indigo-400">
                    ...
                    <p className="mt-3 text-sm text-gray-500">{social.name}</p>
                  </div>
                </div>
              </a>
            ))}
